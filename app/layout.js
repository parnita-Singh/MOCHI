...
const pixelFont = Press_Start_2P({ subsets: ["latin"], variable: "--font-pixel", weight: "400" });
const bodyFont = Quicksand({ subsets: ["latin"], variable: "--font-body", weight: ["400", "500", "600", "700"] });

export const metadata = {
  title: "Mochi",
  description: "Your personal wallet tracker and financial assistant",
  icons: { icon: "/photos/logo.png" },
};
