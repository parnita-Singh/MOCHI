    ...
    <main className="min-h-screen bg-black flex" style={{ color: "#F3F1EE", fontFamily: "Poppins, sans-serif" }}>
      ...
      <div className="relative flex flex-col items-center justify-center" style={{
        ...
        <p style={{ fontSize: "12px", color: "#B46A72", marginBottom: "18px" }}>
          Your financial companion awaits
        </p>
 
        {/* Name row */}
        <div style={{ display: "flex", gap: "15px", width: "100%" }}>
          {[["First Name", "Sarah", "firstname"], ["Last Name", "Jones", "lastname"]].map(([label, placeholder, name]) => (
            <div key={name} style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", width: "100%" }}>
              <label style={{ color: "#7a7a7a", fontSize: "12px", marginBottom: "6px" }}>{label}</label>
              <input
                type="text"
                name={name}
                ...
                style={{ width: "100%", padding: "12px", border: "2px solid gray-600", borderRadius: "8px",
                   background: "#262626", boxSizing: "border-box", marginBottom: "4px", color: "white", 
        ...
        <div style={{ position: "relative", width: "100%", marginTop: "12px" }}>
          ...
          <input
            ...
            required
            className="signup-input"
            style={{ width: "100%", padding: "12px", paddingRight: "40px", border: "2px solid gray-600", 
        ...
        <div style={{ position: "relative", width: "100%", marginTop: "12px" }}>
          ...
          <input
            ...
            className="signup-input"
            style={{ width: "100%", padding: "12px", paddingRight: "40px", border: "2px solid gray-400", 
              borderRadius: "8px", background: "#262626", boxSizing: "border-box", color: "white", 
              transition: "transform 0.25s ease, border-color 0.25s ease" }}
          />
          ...
          {/* Strength bar */}
          <div style={{ width: "100%", height: "8px", background: "#333", borderRadius: "20px", marginTop: "10px", overflow: "hidden" }}>
            <div style={{ width: strength.width, height: "100%", backgroundColor: strength.color, transition: "all .3s ease" }} />
          </div>
          <p style={{ color: strength.color, fontSize: "12px", marginTop: "4px" }}>{strength.text}</p>
        </div>
        ...
        <button className="signup-btn" style={{
          ...
          marginTop: "30px", transition: "all .3s ease"
        }}>
          Create my Account
        </button>
        ...
        <p style={{ color: "#555", fontSize: "12px", marginTop: "16px" }}>
          ...
          <Link href="/sign-in" style={{ color: "#7087BB" }}>Sign in</Link>
        </p>
          {/*Google button*/}
         {/*line */}
